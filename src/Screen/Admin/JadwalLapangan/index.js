...
const JadwalLapangan = ({navigation}) => {
  const [dataJadwals, setDataJadwals] = useState([]);
      ...
      <OnPress onPress={() => setVisible(true)} style={style.menuItem}>
        <Menu
          ...
          <Menu.Item
            ...
            onPress={() => {
              setVisible(false);
              navigation.navigate('FormJadwalLapangan', item);
            }}
            title="Update"
          />
          <Menu.Item
